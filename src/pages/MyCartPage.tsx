...
if(loading){
  ...
  <nav className="fixed bottom-5 left-0 right-0 z-30 mx-auto w-full">
    <div className="mx-auto max-w-[640px] px-5">
      <div className="flex items-center gap-[45px] rounded-[24px] bg-custom-dark px-[20px] py-[14px]">
        <div>
        ...
        {cart.length != 0 ? (
          ...
          <p className="w-full rounded-full bg-custom-primary px-[18px] py-[14px] text-center font-semibold text-white transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]">
            Lanjut
          </p>
        </Link>
        ) : (' ')}
