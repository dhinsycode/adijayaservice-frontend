...
export default function SuccessBookingPage () {
  ...
  <div className="relative mt-[44px] px-5">
    ...
    <section
      id="BookingDetails"
      className="mt-[30px] flex flex-col gap-4 rounded-3xl border border-custom-light bg-white px-[14px] py-[14px]"
    >
      <label className="flex flex-col gap-2">
        ...
        <div className="relative h-[52px] w-full overflow-hidden rounded-full border border-custom-light bg-[#F4F5F7]">
          ...
          <input
            ...
            className="h-full w-full rounded-full bg-transparent pl-[50px] font-semibold leading-6 placeholder:text-[16px] placeholder:font-normal placeholder:text-custom-gray focus:outline-none"
    ...
    <section id="Btn" className="mt-[54px] flex flex-col gap-[14px]">
      <Link to={`/`}>
        <p className="w-full rounded-full bg-custom-primary py-[14px] text-center font-semibold text-white transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]">
          Pemesanan Layanan Kembali
        </p>
      </Link>
      <Link to={`/my-booking`}>
        <p className="w-full rounded-full bg-custom-dark py-[14px] text-center font-semibold text-white">
