      ...
      <div className="flex items-center justify-between rounded-[22px] bg-white px-4 py-[14px]">
        ...
        <ul className="flex items-center gap-[10px]">
          ...
          {/* <li className="shrink-0">
            <a href="#">
              <div className="flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-full border border-custom-light">
                <img
        ...
        {categories.length > 0 ? 
            categories.map((category) => (
                <SwiperSlide key={category.id}className="swiper-slide !w-fit">
                    ...
                    <div className="shrink-0 space-y-3 rounded-[24px] border border-x-custom-light bg-white py-4 text-center transition-all duration-300 hover:border-custom-primary">
                        ...
                        <div className="flex min-w-[130px] flex-col gap-[2px]">
                            ...
                            <p className="text-sm leading-[21px] text-custom-gray">
                                {category.home_services_count} Layanan
                            </p>
                        </div>
                    </div>
                    </Link>
    ...
    >
        ...
        <SwiperSlide key={service.id} className="swiper-slide !w-fit">
          ...
          <Link to={`/service/${service.slug}`} className="card">
            <div className="relative flex w-[230px] shrink-0 flex-col gap-[12px] overflow-hidden rounded-[24px] border border-custom-light bg-white p-4 transition-all duration-300 hover:border-custom-primary">
              ...
              <div className="flex flex-col gap-y-3">
                ...
                <strong className="font-semibold text-custom-primary">
    ...
    <div className="mx-auto max-w-[640px] px-5">
      <div className="rounded-[24px] bg-custom-dark px-[20px] py-[14px]">
        <ul className="flex items-center gap-[20.30px]">
          <li className="w-full">
            <Link to={`/`}>
              <div className="flex items-center justify-center gap-2 rounded-full bg-custom-primary px-[18px] py-[10px] transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]">
                <img
          ...
          <li className="shrink-0">
            <Link to={`/my-booking`}>
              <div className="flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-full border border-custom-light transition-all duration-300 hover:border-custom-primary">
                <img
