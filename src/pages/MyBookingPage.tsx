        ...
        <main className="relative mx-auto min-h-screen w-full max-w-[640px] bg-[#F4F5F7] px-5 pb-[138px] pt-[50px]">
            ...
            <div className="relative flex flex-col gap-5">
                ...
                <form onSubmit={handleSubmit}>
                    <section className="flex flex-col gap-4 rounded-3xl border border-custom-light bg-white px-[14px] py-[14px]">
                        <label className="flex flex-col gap-2">
                            ...
                            <div className="relative h-[52px] w-full overflow-hidden rounded-full border border-custom-light focus-within:border-custom-primary">
                                <img
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full rounded-full bg-custom-primary py-[14px] text-center font-semibold text-white hover:shadow-[0px_4px_10px_0px_#D04B1E80]"
                        >
                            {loading ? "Sedang Mencari..." : "Cari Pemesanan Saya"}
                        </button>
                    </section>
                </form>
                ...
                {!loading && notFound && (
                    <section
                        id="NotFound"
                        className="flex flex-col items-center gap-4 rounded-3xl border border-custom-light bg-white px-[14px] py-[14px]"
                    >
                        <img
...
>
    <div id="BookingStatus" className="relative w-full pb-[50px] pt-4 px-4">
        <div className="flex items-center">

            {/* STEP 1: Membuat Pesanan (Paling Kiri) */}
            <div className="relative z-10 flex h-[25px] w-[60px] items-center">
                <div className="h-2 w-full rounded-full bg-[#0CA024]" />
                <div className="absolute left-0 top-0 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-[6px]">
                        {/* Selalu Hijau karena booking sudah dibuat */}
                        <div className="flex h-[25px] w-[25px] items-center justify-center rounded-full bg-[#0CA024] text-xs font-bold text-white">
                            1
                        </div>
                        <p className="whitespace-nowrap text-center text-xs font-semibold leading-[18px] text-black">
                            Membuat<br />Pesanan
                        </p>
                    </div>
                </div>
            ...
            {/* STEP 2: Konfirmasi Pembayaran (Tengah) */}
            <div className="relative flex h-[25px] w-full items-center">
                {/* Garis konektor dinamis mengikuti variabel warna biru contoh anda */}
                <div className={`h-2 w-full ${bookingDetails.is_paid ? "bg-[#0CA024]" : "bg-[#4c5a8c]"}`} />
                ...
                <div className="absolute left-1/2 top-0 z-10 -translate-x-1/2">
                    <div className="flex flex-col items-center gap-[6px]">
                        ...
                        <p className={`whitespace-nowrap text-center text-xs font-semibold leading-[18px] ${
            ...
            {/* STEP 3: Mulai Pengerjaan (Paling Kanan) */}
            <div className="relative z-10 flex h-[25px] w-[60px] items-center">
                        ...
                        <p className={`whitespace-nowrap text-center text-xs font-semibold leading-[18px] ${
                            ...
                            <div id="WorkingScheduleJ" className="flex flex-col gap-4">
                                <label className="flex flex-col gap-2">
                                    ...
                                    <div className="relative h-[52px] w-full overflow-hidden rounded-full border border-custom-light">
                                        <img
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <div className="flex items-center gap-[6px]">
                                            <div className="flex items-center gap-1">
                                                ...
                                                />
                                                <p className="text-xs leading-[18px] text-custom-gray">
                                                    {detail.price}
                                                </p>
                                            </div>
                                            <div className="flex items-center gap-1">
                            ...
                            <div className="flex flex-col gap-4" id="BookingDetailsJ">
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        ...
                                        />
                                        <p className="text-custom-gray">Kode Pemesanan</p>
                                    </div>
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        <img
                                            ...
                                            className="h-[24px] w-[24px] shrink-0"
                                        />
                                        <p className="text-custom-gray">Sub Total</p>
                                    </div>
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        <img
                                            ...
                                            className="h-[24px] w-[24px] shrink-0"
                                        />
                                        <p className="text-custom-gray">Pajak 11%</p>
                                    </div>
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        <img
                                            ...
                                            className="h-[24px] w-[24px] shrink-0"
                                        />
                                        <p className="text-custom-gray">Asuransi</p>
                                    </div>
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        <img
                                            ...
                                            className="h-[24px] w-[24px] shrink-0"
                                        />
                                        <p className="text-custom-gray">Tools Layanan</p>
                                    </div>
                                    <strong className="font-semibold">Bebas Biaya</strong>
                                </div>
                                <hr className="border-custom-light" />
                                <div className="flex justify-between">
                                    <div className="flex items-center gap-[10px]">
                                        <img
                                            ...
                                            className="h-[24px] w-[24px] shrink-0"
                                        />
                                        <p className="text-custom-gray">Total Akhir</p>
                                    </div>
                                    <strong className="text-[20px] font-bold leading-[30px] text-custom-primary">
                            ...
                            <div id="YourHomeAddressJ" className="flex flex-col gap-4">
                                <label className="flex flex-col gap-2">
                                    ...
                                    <div className="relative h-[110px] w-full overflow-hidden rounded-[22px] border border-custom-light">
                                        <textarea
                                            readOnly
                                ...
                                <label className="flex flex-col gap-2">
                                    ...
                                    <div className="relative h-[52px] w-full overflow-hidden rounded-full border border-custom-light bg-[#F4F5F7]">
                                        <img
            ...
            <nav className="fixed bottom-5 left-0 right-0 z-30 mx-auto w-full">
                <div className="mx-auto max-w-[640px] px-5">
                    <div className="rounded-[24px] bg-custom-dark px-[20px] py-[14px]">
                        <ul className="flex items-center gap-[10.67px]">
                            <li className="shrink-0">
                                <Link to={`/`}>
                                    <div className="flex h-[44px] w-[44px] shrink-0 items-center justify-center rounded-full border border-custom-light hover:border-custom-primary">
                                        <img
                            ...
                            <li className="w-full">
                                <Link to={`/my-booking`}>
                                    <div className="flex items-center justify-center gap-2 rounded-full bg-custom-primary px-[18px] py-[10px] hover:shadow-[0px_4px_10px_0px_#D04B1E80]">
                                        <img
