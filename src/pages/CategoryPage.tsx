...
export default function CategoryPage () {
  ...
  <section id="LatestServices" className="relative flex flex-col gap-[40px]">
    <div className="flex flex-col gap-[14px]">
      ...
      <Link to={`/service/${service.slug}`} key={service.id}>
        <div className="mx-5 flex gap-3 rounded-[24px] border border-custom-light bg-white p-4 transition-all duration-300 hover:border-custom-primary">
  ...
  >
    <div className="mx-auto flex max-w-[640px] justify-center">
      <button type="button">
        <div className="mx-auto flex !w-fit shrink-0 items-center gap-2 rounded-full bg-custom-primary px-[18px] py-[14px] transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]">
