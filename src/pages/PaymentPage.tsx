...
export default function PaymentPage () {
  ...
  <div className="relative mt-[44px] flex flex-col px-5 pb-5">
    ...
    <div className="mt-[20px] flex flex-col gap-5">
      ...
      <section id="PaymentMethod" className="grid grid-cols-2 gap-[14px]">
        <div className="flex items-center justify-center gap-[10px] rounded-[20px] bg-custom-dark py-[14px]">
          <img
         ...
         <div className="flex items-center justify-center gap-[10px] rounded-[20px] border border-custom-light bg-white py-[14px]">
          <img
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col gap-[10px]">
              <div className="flex flex-col gap-[2px]">
                <h4 className="text-custom-gray">Bank</h4>
                <strong className="font-semibold">Bank Central Asia</strong>
              </div>
              <div className="flex flex-col gap-[2px]">
                <h4 className="text-custom-gray">Nomor Rekening</h4>
                <strong className="font-semibold">18209301928391</strong>
              </div>
              <div className="flex flex-col gap-[2px]">
                <h4 className="text-custom-gray">Nama Pemilik Rekening</h4>
    ...
    <form onSubmit={handleSubmit} className="mt-[20px]">
        ...
        <div id="ConfirmationJ" className="flex flex-col gap-4">
          <label className="flex flex-col gap-2">
            ...
            <div className="relative flex h-[52px] w-full items-center overflow-hidden rounded-full border border-custom-light transition-all duration-300 focus-within:border-custom-primary">
              <img
  ...
  {successMessage && (
    <div className="mt-4 rounded-lg bg-green-100 p-3 text-sm text-green-700">
      ...
      <button
        type="submit"
        className="mt-[54px] w-full rounded-full bg-custom-primary py-[14px] font-semibold text-white transition-all duration-300 hover:shadow-[0px_4px_10px_0px_#D04B1E80]"
      >
